export const LoadingLogo = () => (
  <div className="relative flex h-screen w-screen flex-col items-center justify-center overflow-hidden rounded-xl p-2 before:absolute before:inset-0 before:-translate-x-full before:animate-[shimmer_1.5s_infinite] before:bg-gradient-to-r before:from-transparent before:via-white/20 hover:shadow-lg  md:flex-row md:gap-0">
    <svg
      version="1.0"
    ...
    >
      ...
      >
        <path
          d="M184 1357 c-38 -40 -86 -90 -107 -113 l-38 -41 163 -83 c98 -49 176
...
-14 -13 -23 -15 -21 -5 5 15 46 22 46 3 0 -1 -11 -7 -25z"
        />
        <path
          d="M668 782 c-34 -3 -36 -5 -40 -43 -3 -38 4 -50 17 -29 4 6 15 8 26 5
15 -5 19 -1 19 17 0 13 5 29 12 36 15 15 10 18 -34 14z"
        />
        <path
          d="M940 778 c0 -4 5 -10 10 -13 6 -3 10 -18 10 -32 0 -19 4 -24 16 -19
9 4 23 1 30 -5 12 -9 14 -4 14 29 0 39 -1 40 -40 44 -22 2 -40 0 -40 -4z"
        />
        <path
          d="M727 762 c-26 -28 -20 -49 14 -61 18 -6 33 -11 34 -11 2 0 8 14 15
30 10 24 10 33 0 45 -17 20 -43 19 -63 -3z"
        />
        <path
          d="M856 767 c-17 -13 -17 -15 -2 -45 19 -36 16 -35 50 -22 18 6 26 17
26 33 0 43 -38 60 -74 34z"
        />
        <path
          d="M805 697 c-14 -27 -23 -36 -34 -31 -53 21 -59 17 -42 -29 9 -22 6
...
-18 -38z"
        />
        <path
          d="M642 678 c-15 -15 -16 -64 -1 -73 8 -6 69 12 69 20 0 1 -5 16 -11 34
-11 32 -35 41 -57 19z"
        />
        <path
          d="M950 678 c0 -7 -3 -22 -6 -34 -4 -16 1 -24 25 -33 16 -7 35 -10 40
-6 15 9 14 58 -1 73 -16 16 -58 15 -58 0z"
        />
        <path
          d="M572 617 c-28 -30 -28 -38 3 -67 19 -18 25 -20 25 -8 0 9 7 21 15 28
13 11 14 15 2 29 -8 9 -16 22 -18 29 -3 9 -11 6 -27 -11z"
        />
        <path
          d="M637 563 c-12 -11 -8 -68 5 -81 10 -10 48 -18 48 -9 0 1 4 17 9 35 9
30 7 33 -19 47 -33 17 -34 17 -43 8z"
        />
        <path
          d="M968 556 c-30 -11 -33 -21 -18 -60 11 -31 30 -33 53 -8 37 40 13 86
-35 68z"
        />
        <path
          d="M546 525 c4 -16 17 -50 30 -75 l23 -45 1 46 c0 38 -5 50 -31 75 l-31
29 8 -30z"
        />
        <path
          d="M738 467 c-33 -13 -37 -46 -10 -70 24 -22 35 -21 57 3 15 17 16 24 5
50 -14 33 -13 33 -52 17z"
        />
        <path
          d="M855 448 c-14 -29 -14 -33 1 -50 21 -23 37 -23 57 0 27 29 21 59 -13
70 -27 10 -30 8 -45 -20z"
        />
        <path
          d="M630 418 l0 -38 42 0 c33 0 39 3 30 12 -7 7 -12 22 -12 34 0 17 -7
23 -30 26 -29 4 -30 3 -30 -34z"
        />
        <path
          d="M1300 1254 c-54 -94 -107 -174 -122 -186 -16 -11 -28 -29 -28 -41 0
